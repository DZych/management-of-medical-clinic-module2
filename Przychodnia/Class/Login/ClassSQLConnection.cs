...
{
    static class ClassSQLConnection
    {
        ...
        public static bool CheckLoginDetails(string login, string password)
        {
        ...
        //Check if login and password is correct if you want to login
        public static bool CheckLoginAndEmail(string login, string email)
        {
            bool find = false;
        ...
        public static void ChangePassword(string login, string email, string newPassword)
        {
